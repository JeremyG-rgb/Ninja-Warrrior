...
// couleur des bandes externes aux jeux //
constructor() {
    super({
    ...
    document.body.appendChild(this.view);
        ...
        this.start();
//faire charger les textures//

        this._loader.add("assets/paysage.json");
        this._loader.add("assets/ninja.json");
        this._loader.add("assets/FEnemy.json");
        this._loader.add("assets/sprites.json");
        this._loader.add("assets/ground.json");
    ...
    private _onLoaded() {
        ...
        // container for having something solid in the background , background centrale
    ...
    const htmlaudio: HTMLAudioElement = new Audio(this.audio);
    htmlaudio.play();*/
